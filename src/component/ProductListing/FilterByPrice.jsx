        ...
        <div>
            <div className="pb-3">
                <form action="" id='price_form'>
                    <label forhtml="min" className="form-label">Price:- ${range} </label>
                    <input type="range" className="form-range" id='range' defaultValue={1800} min="0" max="1800" onChange={(e) => { setrange(e.target.value) }} />
